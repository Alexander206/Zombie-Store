...
const imagenes = require.context('../assets/objetos', true);
  ...
  return (
    <article id='list'>
      ...
      <p className='Paragraph'>
        Equípate para sobrevivir en un mundo post-apocalíptico con nuestra sección de objetos. Ofrecemos una amplia
        variedad de objetos para ayudarte a sobrevivir en un mundo en ruinas.
      </p>
      ...
      <p className='Paragraph'>
        Desde armas y suministros de supervivencia hasta ropa y equipo de protección, nuestra sección de objetos tiene
        todo lo que necesitas para estar preparado.
      </p>
